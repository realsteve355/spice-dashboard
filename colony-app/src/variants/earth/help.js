// variants/earth/help.js
// Earth-colony HELP content for the Layout drawer.
// No V-token entries — Earth colonies don't run V. Long-term savings happen
// outside the colony (bank / broker / external wallet).
export const HELP = {
  mall: {
  ...
  dashboard: {
    ...
    sections: [
      ...
      {
        heading: 'Savings',
        body: 'Long-term savings on Earth happen outside the colony — use a bank, broker, or external wallet. The colony does not run an internal savings instrument.',
      },
      {
  ...
  company: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: 'The secretary controls the company wallet: send MOND to pay suppliers and issue equity stakes.',
      },
      {
        heading: 'Equity',
