// variants/earth/pages/Profile.jsx
// Earth Profile — no V-tokens, no V-pool dependants flow.
// Savings on Earth happen outside the colony (external bank / broker /
// custodial wallet), so we don't show a V balance and we don't link to
// the Mars-only Guardian / dependants screen.
  ...
  return (
    ...
    >
      <div style={{ padding: '16px 16px 0' }}>
        ...
        {isSelf && (
          <div style={card}>
            <div style={{ fontSize: 11, color: C.faint, letterSpacing: '0.1em', marginBottom: 12 }}>BALANCE</div>
            <Row
            ...
            <div style={{ fontSize: 11, color: C.faint, lineHeight: 1.6, paddingTop: 4 }}>
              Long-term savings on Earth happen outside the colony — use a bank,
              broker, or external wallet.
            </div>
          </div>
        )}
