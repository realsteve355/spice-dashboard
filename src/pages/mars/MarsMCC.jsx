...
const CS = {
  ...
  fontSize: 10, fontFamily: 'Share Tech Mono, monospace', color: '#a4a4a4',
}
  ...
  return (
    <div>
      ...
      <div className="md-panel" style={{ borderLeft: '3px solid #c8a96e' }}>
        ...
        <p style={{ fontSize: 11, color: '#a4a4a4', lineHeight: 1.8, letterSpacing: '0.03em' }}>
        ...
        <div className="md-panel">
          ...
          <ResponsiveContainer width="100%" height={160}>
            <LineChart data={withPct} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
              ...
              <YAxis tick={{ fontSize: 9, fill: '#767676' }} domain={[0, 100]} unit="%" width={42} />
        ...
        <div className="md-panel">
          ...
          <ResponsiveContainer width="100%" height={160}>
            <LineChart data={withPct} margin={{ top: 4, right: 8, bottom: 0, left: 0 }}>
              <CartesianGrid stroke="#232831" strokeDasharray="2 4" />
              <XAxis dataKey="year" tick={{ fontSize: 9, fill: '#767676' }} interval={39} />
              <YAxis tick={{ fontSize: 9, fill: '#767676' }} domain={[0, 35]} unit="%" width={42} />
