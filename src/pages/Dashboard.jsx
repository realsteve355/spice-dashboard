      ...
      <div style={S.inner}>
              ...
              {positions.length > 0 ? positions.map(p => {
                ...
                return (
                  <div key={p.label} style={S.posRow}>
                    ...
                    <div style={S.posValues}><span>{fmtUSD(p.value)}</span><span style={{ color: "#555" }}>{pct.toFixed(1)}%</span></div>
                  </div>
                );
        ...
        {activeTab === "lookup" && (
          <div style={S.narrowCard}>
            ...
            {lookupResult?.error && <p style={{ color: "#E05C5C", marginTop: 16, fontSize: 13 }}>{lookupResult.error}</p>}
          </div>
        )}
      </div>
    </div>
...
function StatRow({ label, value, accent }) {
  return (
    <div style={S.statRow}>
      ...
      <span style={{ ...S.statValue, color: accent ? "#C9A84C" : "#E8E4DC" }}>{value}</span>
    </div>
  );
}
...
const S = {
  ...
  testnetBanner: { background: "#0F0F11", color: "#444", padding: "6px 32px", fontSize: 10, letterSpacing: "0.12em", textAlign: "center", borderBottom: "1px solid #131315" },
  walletBar: { display: "flex", justifyContent: "flex-end", padding: "12px 32px", borderBottom: "1px solid #1A1A1E" },
  walletRow: { display: "flex", alignItems: "center", gap: 8 },
  walletPill: { display: "flex", alignItems: "center", gap: 8, padding: "6px 12px", border: "1px solid #222", fontSize: 12, color: "#888", background: "#0F0F11" },
  dot: { width: 6, height: 6, borderRadius: "50%", background: "#4A9B8F" },
  disconnectBtn: { background: "none", border: "1px solid #222", color: "#555", padding: "6px 12px", fontSize: 11, cursor: "pointer", fontFamily: "inherit" },
  connectBtn: { padding: "8px 20px", background: "#C9A84C", border: "none", color: "#080809", fontSize: 12, fontWeight: 700, cursor: "pointer", letterSpacing: "0.08em", fontFamily: "inherit" },
  inner: { maxWidth: 1100, margin: "0 auto", padding: "32px 24px" },
  kpiStrip: { display: "flex", gap: 1, marginBottom: 32, background: "#0F0F11", border: "1px solid #1A1A1E" },
  kpi: { flex: 1, display: "flex", flexDirection: "column", gap: 4, padding: "16px 20px", borderRight: "1px solid #1A1A1E" },
  ...
  tab: { padding: "10px 20px", background: "none", border: "none", color: "#555", fontSize: 11, letterSpacing: "0.1em", cursor: "pointer", fontFamily: "inherit", textTransform: "uppercase", borderBottom: "2px solid transparent", marginBottom: -1 },
  tabActive: { color: "#C9A84C", borderBottom: "2px solid #C9A84C" },
  twoCol: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 },
  card: { background: "#0F0F11", border: "1px solid #1A1A1E", padding: "24px", marginBottom: 16 },
  narrowCard: { background: "#0F0F11", border: "1px solid #1A1A1E", padding: "28px", maxWidth: 520 },
  cardTitle: { fontSize: 11, color: "#555", letterSpacing: "0.15em", margin: "0 0 20px" },
  ...
  statRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px 0", borderBottom: "1px solid #131315" },
  ...
  input: { flex: 1, background: "#080809", border: "1px solid #222", color: "#E8E4DC", padding: "10px 14px", fontSize: 14, fontFamily: "inherit", outline: "none" },
  inputUnit: { background: "#131315", border: "1px solid #222", borderLeft: "none", padding: "10px 12px", fontSize: 11, color: "#555" },
  inputHint: { fontSize: 10, color: "#444", marginTop: 6, display: "block" },
  actionBtn: { width: "100%", padding: "12px", background: "#C9A84C", border: "none", color: "#080809", fontSize: 12, fontWeight: 700, cursor: "pointer", letterSpacing: "0.1em", fontFamily: "inherit", marginBottom: 12 },
  faucetBtn: { width: "100%", padding: "10px", background: "none", border: "1px solid #222", color: "#555", fontSize: 11, cursor: "pointer", fontFamily: "inherit", marginTop: 8 },
  connectPrompt: { textAlign: "center", padding: "24px 0" },
  phase2Warning: { background: "#1A1200", border: "1px solid #3A2800", color: "#C9A84C", padding: "12px 16px", fontSize: 11, marginBottom: 20, lineHeight: 1.6 },
  txFeedback: { marginTop: 16, padding: "12px 16px", border: "1px solid", fontSize: 12, lineHeight: 1.5 },
