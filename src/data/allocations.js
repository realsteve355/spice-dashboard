...
export const ALLOCATIONS = [
  {
    ...
    assets: [
      { name: "PAXG",              pct: 75, color: "#B8860B", note: "Tokenised gold — primary store of value" },
  ...
  },
  {
    ...
    assets: [
      { name: "PAXG",              pct: 60, color: "#B8860B", note: "Core gold position" },
  ...
  },
  {
    ...
    assets: [
      { name: "PAXG",              pct: 45, color: "#B8860B", note: "Core unchanged" },
  ...
  },
  {
    ...
    assets: [
      ...
      { name: "PAXG",              pct: 30, color: "#B8860B", note: "Safe haven absolute" },
  ...
  },
  {
    ...
    assets: [
      ...
      { name: "PAXG",              pct: 20, color: "#B8860B", note: "Reduce — confiscation risk rises in extremis" },
