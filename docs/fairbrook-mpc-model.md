...
- The automation windfall above that goes to the community
- Slim-margin businesses (Carla's Coffee) pay zero — their 2× baseline
  is already higher than their SPICE profit
- Highly automated national chains (Walmart) pay the most
...
## 2. Why Each Cost Line Changes in SPICE World

| Cost line | Today | SPICE world | Why |
|-----------|-------|-------------|-----|
...
automated. Government cost bases collapse → tax rates can fall dramatically.
This is not a loophole — it is the same automation wave hitting every
layer of the economy simultaneously.

---

## 3. Walmart Model — Bellefontaine Store

Estimated revenue: **$50M/year** (serves ~40,000 county catchment)

### Today
| Item | Amount |
|------|--------|
| Revenue | $50.0M |
| Cost of goods (75%) | $37.5M |
| Labour — 300 staff avg $30K | $9.0M |
| Rent/facilities | $2.0M |
| Other operating | $1.5M |
| Employer payroll tax | $0.7M |
| Pre-tax profit | $1.3M |
| Federal + state tax (25%) | $0.32M |
| **Net profit** | **$0.98M** |
| **Net margin** | **~2%** |
...
|------|--------|--------|
| Revenue | $50.0M | same* |
| Cost of goods (66%) | $33.0M | −$4.5M |
| Labour — 30 staff, UBI-supplemented | $0.75M | −$8.25M |
| Rent/facilities | $2.0M | same |
| Other operating | $1.5M | same |
...
*Revenue assumption flagged in Section 5 below.
...
| Lowe's | $1.20M | $7.20M | $4.80M |
| All fast food (8 chains) | $0.90M | $6.30M | $4.50M |
| Pharmacies (CVS/Walgreens/Rite Aid) | $0.55M | $3.85M | $2.75M |
| Banks (×5) | $1.60M | $8.00M | $4.80M |
| Dollar stores | $0.30M | $1.50M | $0.90M |
| Telecoms (×3) | $0.50M | $2.50M | $1.50M |
| Fuel/convenience | $0.40M | $1.60M | $0.80M |
| Manufacturing/distribution | $1.00M | $3.00M | $1.00M |
...
### ⚠️ The revenue circularity problem
**This is the critical unresolved issue.**

The entire model assumes Walmart maintains $50M annual revenue in SPICE world.
But:

- Today, 2,680 displaced workers earn avg $32,000/year = **$85.8M in wages**
  flowing through the local economy
- With $296/month UBI those same workers have **$9.5M/year** — a
  **$76M collapse in local spending power**
- Even with cheaper goods (automated supply chain), $296/month cannot
...
Federal block grant or protocol treasury seeds the reserve with enough
USDC to fund 2-3 years of UBI at target level. Buys time for the
flywheel to reach equilibrium. This is realistic — early colonies
need founding capital.

**Option C — The UBI target is wrong**
In a world with cheaper automated goods, no income tax, and UBI
supplementing rather than replacing wages, the meaningful UBI floor
may be lower than the $400 target. Needs proper cost-of-living
modelling for a SPICE world, not today's prices.

**Option D — Revenue actually increases**
With cheaper goods from automated supply chains, purchasing power
per dollar increases. $296 in SPICE world buys significantly more
than $296 today. Real consumer spending may hold closer to today's
levels than the nominal wage comparison suggests.
...
5. **The cost structure changes at every level** — goods, labour,
   government — not just at the retail layer

---

*Document version: 0.1 (working) — 25 April 2026*
*Based on Bellefontaine, Ohio real data + SPICE protocol economic model*
