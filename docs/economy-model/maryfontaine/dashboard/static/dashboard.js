...
const sliders = [
  ...
  { id: 'mpc', fmt: v => `${(parseFloat(v) * 100).toFixed(1)}%` },
...
function readConfig() {
  return {
    ...
    mpc_enabled: parseFloat(document.getElementById('mpc').value) > 0,
    mpc_rate_pct: parseFloat(document.getElementById('mpc').value),
